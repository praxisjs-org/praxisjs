...
class AsyncDataDemo extends StatefulComponent {
  ...
  @Resource((self: AsyncDataDemo) =>
    fetch(`https://jsonplaceholder.typicode.com/posts?_page=${self.page}&_limit=4`)
    ...
    return (
      <div style="display:flex;flex-direction:column;gap:14px;font-family:sans-serif;min-width:340px;max-width:480px">
        ...
        <div style="padding:10px;background:#f0f9ff;border:1px solid #bae6fd;border-radius:6px;font-size:.78rem;color:#0369a1">
          <strong>How it works:</strong> <code>page</code> is a{" "}
          <code>@State()</code> signal read inside the fetcher. When page
          changes, the resource auto-cancels the in-flight request and starts a
          new one.
          <code>keepPreviousData: true</code> prevents the list from flashing
