...
<Callout type="warn" title="Breaking — @RouterConfig renamed to @Router, Router class renamed to RouterInstance">

| Changed | Before | After |
|---|---|---|
| Root app decorator | `@RouterConfig([...])` | `@Router([...])` |
| Router class (type annotation) | `router!: Router` | `router!: RouterInstance` |
