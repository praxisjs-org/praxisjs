...
| `@praxisjs/jsx` | `0.4.7` | JSX runtime (`jsx-runtime`, `jsx-dev-runtime`) |
...
| `@praxisjs/router` | `1.0.14` | Client-side router with `@Router` and `@Route` decorators |
| `@praxisjs/store` | `1.1.1` | Class-based singleton state with `@Storable` and `@Store` |
