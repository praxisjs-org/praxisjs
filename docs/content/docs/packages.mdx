...
| `@praxisjs/runtime` | `0.5.1` | DOM renderer — mounts components, manages scopes, handles reactive children, Portal |
| `@praxisjs/jsx` | `0.7.0` | JSX runtime (`jsx-runtime`, `jsx-dev-runtime`) |
