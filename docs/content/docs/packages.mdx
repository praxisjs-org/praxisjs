...
| `@praxisjs/css` | `0.2.0` | Scoped CSS with typed class names (`@Styled`), reactive CSS properties (`@Style`), design tokens, and static build-time extraction via the Vite plugin |
