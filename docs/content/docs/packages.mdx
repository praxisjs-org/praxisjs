...
| `@praxisjs/css` | `0.3.0` | Scoped CSS with typed class names (`@Styled`), reactive CSS properties (`@Style`), design tokens, and static build-time extraction via the Vite plugin |
...
| Package | Version | Description |
| ------- | ------- | ----------- |
| `@praxisjs/vite-plugin` | `4.0.1` | Vite integration — decorators, JSX transform, HMR, and CSS static extraction |
