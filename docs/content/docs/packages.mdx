...
| `@praxisjs/runtime` | `0.2.19` | DOM renderer — mounts components, manages scopes, handles reactive children, Portal |
...
| Package | Version | Description |
| ------- | ------- | ----------- |
| `@praxisjs/head` | `0.1.0` | Reactive document head — `@Head` decorator for title, meta, og:*, twitter:* |
