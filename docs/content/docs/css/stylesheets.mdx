...
<StorybookLink story="ecosystem-css-statelessstyled--stateless-styled-story" label="Live demo — @Styled on StatelessComponent" />
...
<StorybookLink story="ecosystem-css-multiplestylesheets--multiple-stylesheets-story" label="Live demo — multiple @Styled fields" />
