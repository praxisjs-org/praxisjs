...
- **[@praxisjs/router](/docs/ecosystem/router)** — Client-side routing with `@Router`, `@Route`, and reactive injectors
- **[@praxisjs/store](/docs/ecosystem/store)** — Singleton state stores with `@Storable` and `@Store`
...
- **[@praxisjs/content](/docs/ecosystem/content)** — Content collections with `@Collection`, `@PagedCollection`, and `getEntry`
- **[@praxisjs/head](/docs/essentials/head)** — Reactive `<head>` management via the `@Head` decorator
- **[@praxisjs/composables](/docs/composables)** — DOM and browser utilities via `@Compose`
- **[@praxisjs/concurrent](/docs/ecosystem/concurrency)** — Async control decorators: `@Task`, `@Queue`, and `@Pool`
...
- **[@praxisjs/mcp](/docs/tooling/mcp)** — MCP server with live documentation access for any MCP-compatible AI assistant
