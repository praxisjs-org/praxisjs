...
| `@praxisjs/head` | Stable | Reactive document head |
| `@praxisjs/content` | Stable | Markdown content collections |
...
| `@praxisjs/mcp` | Beta | MCP server — API surface may change |
| `@praxisjs/ssg` | Experimental | Static site generation — new, expect breaking changes in minor versions |
