...
The MCP server handles documentation lookup. For AI-assisted development that also enforces `CLAUDE.md` management, project config, and PraxisJS conventions, pair it with [`@praxisjs/claude-skill`](/docs/tooling/claude-skill).
