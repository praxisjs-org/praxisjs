...
See the [AI skills guide](/docs/guide/ai-skills) for what each skill does and how to use it, and the [praxisjs CLI](/docs/tooling/cli) reference for `ai remove`, `doctor`, and `upgrade`.
